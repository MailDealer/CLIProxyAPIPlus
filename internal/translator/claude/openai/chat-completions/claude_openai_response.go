...
func calculateClaudeUsageTokens(usage gjson.Result) (promptTokens, completionTokens, totalTokens, cachedTokens, cacheCreationInputTokens int64) {
	...
	return promptTokens, completionTokens, totalTokens, cachedTokens, cacheCreationInputTokens
}
